...
export default function PdfViewer({fileUrl}: {fileUrl: string}){
    ...
    return (
        <div className="flex flex-col w-full h-full">
            ...
            <div className="mt-4 mb-2 flex flex-wrap items-center justify-center gap-3 px-3 rounded-md bg-gray-100 dark:bg-gray-500 shadow-sm text-sm text-gray-900 dark:text-gray-200">
                <ZoomOutButton />
                <ZoomInButton />
                <GoToPreviousPage />
                <NumberOfPages />
